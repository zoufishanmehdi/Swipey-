...
SWIFT_CLASS("_TtC6Donate11AppDelegate")
...
SWIFT_CLASS("_TtC6Donate14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified expireDateTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified cvcTextField;
...
@property (nonatomic, copy) IBOutletCollection(UITextField) NSArray<UITextField *> * _Null_unspecified textFields;
- (BOOL)textFieldShouldReturn:(UITextField * _Nonnull)textField;
- (IBAction)donate:(id _Nonnull)sender;
